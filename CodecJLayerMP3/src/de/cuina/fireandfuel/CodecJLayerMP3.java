 ...
 *
 * <br><br>This software is based on or using the JLayer and mp3spi library from http://www.javazoom.net/javalayer/javalayer.html and Tritonus library from http://www.tritonus.org/.
 *
...
public class CodecJLayerMP3 {
	...
	public SoundBuffer read() {
		...
		byte[] streamBuffer = new byte[655360];
	...
	public SoundBuffer readAll() {
		...
		if (fileSize > 0) {
			...
			smallBuffer = new byte[2000000];

			// Read until end of file or maximum file size is reached.
			while ((!endOfStream(GET, XXX)) && (totalBytes < 2000000)) {
				bytesRead = 0;
				cnt = 0;
